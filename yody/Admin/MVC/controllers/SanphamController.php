...
//add san pham
    ...
    {
        $target_dir = "../images/products/";  // thư mục chứa file upload
        ...
        if ($status_upload) { // nếu upload file không có lỗi 
            $HinhAnh1 =  "products/" . basename($_FILES["HinhAnh1"]["name"]);
        }
        ...
        if ($status_upload) { // nếu upload file không có lỗi 
            $HinhAnh2 =  "products/" . basename($_FILES["HinhAnh2"]["name"]);
        }
        ...
        if ($status_upload) { // nếu upload file không có lỗi 
            $HinhAnh3 =  "products/" . basename($_FILES["HinhAnh3"]["name"]);
        }
