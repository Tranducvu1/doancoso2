<header class="header-one header-two">
                ...
                <div class="col-sm-12">
                    <div class="middel-top">
                        <div class="left floatleft">
                            <p><i class="mdi mdi-clock"></i> T2 - CN : 08:00-20:00</p>
                        </div>
                    </div>
    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-sm-2">
                <div class="logo">
                    <a href="?act=home"><img src="images/logotv.png" alt="Sellshop"  style="padding-right: 10px;"/></a>
                </div>
            </div>
            <div class="col-sm-8">
                    ...
                    <div class="mainmenu">
                        <nav>
                            <ul>
                                        ...
                                        <?php    $i = 1; foreach ($data_chitietDM as $row) { ?>
                                            <li>
                                                ...
                                                <ul>        
                                                    ...
                                                    <li><a href="?act=shop&sp=<?=$value['MaDM']?>&loai=<?=$value['TenLSP']?>"><?=$value['TenLSP']?></a>
                                                    </li>
                                ...
                                <li><a href="?act=about">Hệ thống</a></li>
                ...
                <div class="cart-itmes">
                    ...
                    <div class="cartdrop">
                        ...
                        <a href="?act=cart&xuli=deleteall&id=<?= $value['MaSP'] ?>"><i class="mdi mdi-close" title="Remove this product"></i></a>
                            <a class="cart-img" href="?act=cart"><img src="images/<?=$value['HinhAnh1']?>" alt="" /></a>
